...
<div>
    ...
    <p></p>
                ...
                <div class="center"><h3>Isikan Nama Keranjang Yang Akan Dihapus</h3>
					<form method="post" action="/mvc-example/?act=deletego">
					  <div class="form-group">
					    <!-- <label for="exampleInputNim">Nama Keranjang</label> -->
					    <input type="text" class="form-control" id="exampleInputDel" name="del" placeholder="Contoh 'sobatkeren'">
					  </div>
					  <button type="submit" class="button button3">Hapus</button>
					</form>
                </div>
